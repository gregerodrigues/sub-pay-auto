...
contract CreatePoolAndAddLiquidityScript is BaseScript, LiquidityHelpers {
    ...
    int24  public initialTick = -69060;
    uint160 public startingPrice = TickMath.getSqrtPriceAtTick(initialTick);

    // your balances
    uint256 public token0Amount = 5e6;        // 5 USDC (6d)
    uint256 public token1Amount = 0.005e18; 
